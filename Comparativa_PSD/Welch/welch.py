...
lib_path = os.path.abspath("/home/gcpds/Desktop/Procesamiento_ANE2/ANE2_procesamiento/Comparativa_PSD/Algoritmo/libs/libpsd.so")
try:
...
mis_capturas = [
    {
        ...
        "frecuencia_central": 95.7*1000000,  # 103.7 MHz
        "ancho_banda": 20*1000000,         # 20 MHz
        "num_muestras": 2*1000000,        # ~2 segundos (suficiente para Welch)
        "lna": 40,                       # Ganancia LNA un poco más alta para ver detalles
        "vga": 0, 
        "amp": 0
    }
]
